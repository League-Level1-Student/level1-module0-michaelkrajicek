...
public class FinishLine {
	...
	static void crazyMove() {
		...
		int numMoves = new Random().nextInt(45)+10;
		for (int i = 0; i < numMoves; i++ ) { 
			...
			int dist = new Random().nextInt(33);
			rob.move(dist);
			totalDistance+=dist;
		}
	}
